...
class ArticlesViewHandler
{
    ...
    public function handleRepresentation(Articles $representation, array $params = array())
    {
    ...
    private function getNavigationLinks(Pagerfanta $pager, array $params = array())
    {
        ...
        if ($pager->getCurrentPage() > 1) {
            $links['first'] = $this->generateUrl('app_api_articles',
                array_merge($params, [
        ...
        if ($pager->hasPreviousPage()) {
            $links['previous'] = $this->generateUrl('app_api_articles',
                array_merge($params,
                    [
        ...
        if ($pager->hasNextPage()) {
            $links['next'] = $this->generateUrl('app_api_articles',
                array_merge($params,
                    [
        ...
        if ($pager->getNbPages() != $page) {
            $links['last'] = $this->generateUrl('app_api_articles',
                array_merge($params,
                    [
